    ...
    <footer class="footer bg-dark">
      <div class="container">
        <p class="m-0 text-center text-white" title="Para más desarrollos accede a configuroweb.com">Sistema de Inventario &copy; <a href="https://www.configuroweb.com/">ConfiguroWeb</a> <?php echo date('Y'); ?></p>
      </div>
    </footer>
