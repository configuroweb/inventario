							...
							<form>
							  <div class="form-row">
								<div class="form-group col-md-3" style="display:inline-block">
								  <label for="itemDetailsItemNumber">N Producto<span class="requiredIcon">*</span></label>
							  ...
							  <button type="button" id="addItem" class="btn btn-success">Agregar Producto</button>
				  ...
				  <div class="card-body">
					...
					<form>
					  ...
					  <div class="form-row"> 
						  ...
						  <div class="form-group col-md-2">
							  <label for="purchaseDetailsCurrentStock">Existensias Actuales</label>
				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div id="vendorDetailsMessage"></div>
					 <form> 
					  ...
					  <div class="form-group">
						<label for="vendorDetailsVendorAddress2">Departamento</label>
						<input type="text" class="form-control" readonly value="Valle del Cauda" id="vendorDetailsVendorAddress2" name="vendorDetailsVendorAddress2">
					  </div>
					  <div class="form-row">
						<div class="form-group col-md-6">
						  <label for="vendorDetailsVendorCity">Ciudad</label>
						  <input type="text" value="Cali" readonly class="form-control" id="vendorDetailsVendorCity" name="vendorDetailsVendorCity">
						</div>
						<div class="form-group col-md-4">
						  <label for="vendorDetailsVendorDistrict">Barrio</label>
				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div class="card-body">
					...
					<form>
					  <div class="form-row">
						<div class="form-group col-md-3">
						  <label for="saleDetailsItemNumber">N Producto<span class="requiredIcon">*</span></label>
				...
				<div class="card card-outline-secondary my-4">
				  ...
				  <div id="customerDetailsMessage"></div>
					 <form> 
					  ...
					  <div class="form-group">
						<label for="customerDetailsCustomerAddress2">Departamento</label>
						<input type="text" class="form-control" readonly id="customerDetailsCustomerAddress2" value="Valle del Cauca"name="customerDetailsCustomerAddress2">
					  </div>
					  <div class="form-row">
						<div class="form-group col-md-6">
						  <label for="customerDetailsCustomerCity">Ciudad</label>
						  <input type="text" class="form-control" readonly id="customerDetailsCustomerCity" value="Cali" name="customerDetailsCustomerCity">
						</div>
						<div class="form-group col-md-4">
